package org.xumin.contactapi.service;
...
import org.xumin.contactapi.repo.ContactRepo;
...
public class ContactService {
    ...
    private final BiFunction<String, MultipartFile, String> photoFunction = (id, image) -> {
        ...
        try{
            ...
            return ServletUriComponentsBuilder.fromCurrentContextPath().path("/api/contacts/image/" + filename).toUriString();
        }catch (Exception e){
